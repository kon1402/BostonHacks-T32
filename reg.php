                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Reaching</strong> Out</h1>
                            <div class="description">
                            	<p>
	                            	bla bla bla <a href="http://azmind.com"><strong>bla blaaaaa</strong></a>, lol!
                            	</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="login.php" method="post">
			                        ...
			                        <button style="background-color: #CBC3E3; type="submit" class="btn">Sign in!</button>
			                    </form>
		                    </div>
                        </div>
                    </div>
